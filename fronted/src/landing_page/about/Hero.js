  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-2 text-center p">
      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{fontSize:"1.2em", lineHeight:"1.8"}}>
        ...
        <div className="col-6 p-5">
          ...
          latest updates on our <a href="" style={{textDecoration:"none"}}>blog</a> or see what the media is <a href="" style={{textDecoration:"none"}}>saying about us.</a></p>
        </div>
      </div>
    </div>
  );
